...
while (n < 10) {
    ...
    WebUI.setText(findTestObject('Object Repository/Page_Off-Topic - myteam Mattermost/textarea_1'), '12')

    WebUI.setText(findTestObject('Object Repository/Page_Off-Topic - myteam Mattermost/textarea_12'), '123')

    WebUI.setText(findTestObject('Object Repository/Page_Off-Topic - myteam Mattermost/textarea_12'), Keys.chord(Keys.ENTER))

    WebUI.verifyElementText(findTestObject('Object Repository/Page_Off-Topic - myteam Mattermost/p_123'), '123')
}
