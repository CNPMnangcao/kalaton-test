...
WebUI.click(findTestObject('Object Repository/Page_Town Square - myteam Mattermost/button_Account Settings'))
...
WebUI.click(findTestObject('Object Repository/Page_Town Square - myteam Mattermost/div_userb'))
