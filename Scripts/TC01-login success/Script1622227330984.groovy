...
WebUI.setText(findTestObject('Object Repository/Page_Mattermost/input_All team communication in one place, _a3edc6'), password)

WebUI.click(findTestObject('Object Repository/Page_Mattermost/button_Sign in'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - myteam Mattermost/h1_myteam'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - myteam Mattermost/button_Log Out'))
