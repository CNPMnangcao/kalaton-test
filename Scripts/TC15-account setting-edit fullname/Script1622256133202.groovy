...
WebUI.click(findTestObject('Object Repository/Page_Town Square - myteam Mattermost/span'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - myteam Mattermost/button_usera_style--none sidebar-header-dro_5f5fae'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - myteam Mattermost/span_Account Settings'))
